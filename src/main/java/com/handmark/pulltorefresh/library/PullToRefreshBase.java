...
import com.handmark.pulltorefresh.library.internal.MyLoaddingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        mHeaderLayout = new TweenAnimLoadingLayout(context,Mode.PULL_FROM_START,Orientation.VERTICAL,a);
